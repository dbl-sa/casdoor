...
export function getUserCommonFields() {
  return ["Owner", "Groups", "Name", "Roles", "Permissions", "CreatedTime", "UpdatedTime", "DeletedTime", "Id", "Type", "Password", "PasswordSalt", "DisplayName", "FirstName", "LastName", "Avatar", "PermanentAvatar",
